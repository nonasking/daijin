...
case "$NODE" in
  dev1) FLAGS="-DFEAT_SERVO=1 -DFEAT_BUZZER=1 -DFEAT_RELAY=1 -DFEAT_STEPPER=0 -DSERVO_REST=180 -DNODE_COLOR=\"red\"" ;;    # 레드: 서보(대기 180도) + 부저 + 릴레이
  dev2) FLAGS="-DFEAT_SERVO=0 -DFEAT_BUZZER=1 -DFEAT_RELAY=0 -DFEAT_STEPPER=1 -DMOTOR_STEP_DEG=360 -DNODE_COLOR=\"blue\"" ;;   # 블루: 스텝모터(motor=한 바퀴) + 부저
